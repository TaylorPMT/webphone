...
<link rel="stylesheet" type="text/css" href="frontend/frontend/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo"><a href="#">TTTN</a></div>
							<nav class="main_nav">
								<ul>
									@foreach($menu as $me)
	...
	<div class="avds">
		<div class="avds_container d-flex flex-lg-row flex-column align-items-start justify-content-between">
			<div class="avds_small">
				<div class="avds_background" style="background-image:url(frontend/images/avds_small.jpg)"></div>
				<div class="avds_small_inner">
					<div class="avds_discount_container">
						<img src="frontend/images/discount.png" alt="">
						<div>
			...
			<div class="avds_large">
				<div class="avds_background" style="background-image:url(frontend/images/avds_large.jpg)"></div>
