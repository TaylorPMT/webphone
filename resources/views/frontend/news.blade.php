				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo"><a href="{{Route('trangchu')}}">Home</a></div>
							<nav class="main_nav">
								<ul>
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<!-- Product -->
						<div class="product">
							<div  class="product_image" > <a href="{{route('getChitiet',$tin->id)}}"><img src="{{$tin -> img}}" alt=""></a></div>
							<div class="product_content">
								<div class="product_title"><a href="{{route('getChitiet',$tin->id)}}">{{$tin -> title}}</a></div>
