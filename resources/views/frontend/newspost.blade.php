			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						@foreach($baipostlienquan as $tin)
						<!-- Product -->
						<div class="product">
							<div  class="product_image" > <a href="{{Route('getChitiet',['id'=>$tin->id])}}"><img src="{{$tin -> img}}" alt="{{$tin->slug}}" width="300px;height:300px;"></a></div>
							<div class="product_content">
								<div class="product_title"><a href="chitiet.html">{{$tin -> title}}</a></div>
